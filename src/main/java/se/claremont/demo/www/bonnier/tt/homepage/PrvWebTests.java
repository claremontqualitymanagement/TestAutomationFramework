...
public class PrvWebTests extends TestSet {
    ...
    public void testSetup() {
        ...
        System.setProperty("webdriver.chrome.driver", Utils.getInstance().getUserWorkingDirectory() + File.separator + "drivers" + File.separator + "chromedriver");

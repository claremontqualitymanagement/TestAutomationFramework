package se.claremont.taf.logging;
...
import se.claremont.taf.support.ColoredConsolePrinter;
import se.claremont.taf.support.StringManagement;
import se.claremont.taf.support.SupportMethods;
import se.claremont.taf.testcase.TestCaseLog;
import se.claremont.taf.testrun.TestRun;

import java.text.SimpleDateFormat;
import java.util.Date;

import static se.claremont.taf.reporting.testcasereports.TestCaseLogReporterHtmlLogFile.enumMemberNameToLower;

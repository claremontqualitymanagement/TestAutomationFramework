...
public class TafGuiColorOriginal extends TafGuiColor {
    ...
    private static Color textColor = new Color(119, 150, 178); //Dark blue


    //public static Color disabledColor = new Color(119, 150, 178); //Dark blue
    private static Color disabledColor = new Color(150, 192, 230); //Light blue
}

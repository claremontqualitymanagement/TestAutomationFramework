...
public class CliTestRunnerTest {
    ...
    public void usageInstructionsShouldBeWrittenOnNoArguments(){
        ...
        Assert.assertTrue(testOutputChannel.toString().contains("Usage instruction"));
    }
    ...
    public void diagnosticsKeyWordShouldRunDiagnosticsTests(){
        ...
        CliTestRunner.runInTestMode(args);
        Assert.assertTrue(testOutputChannel.toString().contains("Running diagnostic"));
    }
    ...
    public void runSettingsFileShouldBeSetIfStatedInCLI(){
        ...
        CliTestRunner.runInTestMode(args);
        Assert.assertTrue(testOutputChannel.toString().contains("Run settings properties file = '/Temp/MySettings.settings'"));
    }
    ...
    public void settingsShouldBeStatedFromCli(){
        ...
        CliTestRunner.runInTestMode(args);
        Assert.assertTrue(testOutputChannel.toString().contains("http://mysite.com/logo.png"));
        Assert.assertTrue(TestRun.getSettingsValue(Settings.SettingParameters.PATH_TO_LOGO).equals("http://mysite.com/logo.png"));
    }
